...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '2250565647864';
            const dj2 = '2250565647864';
            const luffy = '2250799684818';
            var superUser = [servBot, dj, dj2, luffy].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
            var dev = [dj, dj2, luffy].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
                                ...
                                if (!dev || !superUser) {
                                    if (verifZokouAdmin) {
                                        if (!verifAdmin) {
                                            ...
                                            const gifLink = "https://raw.githubusercontent.com/Arima8000/V-Arima/main/media/remover.gif";
